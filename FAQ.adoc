...
In short: I believe that it has happened.
...
Even if we had a video showing the whole process, showing the whole money flow from donor to prison guard, it would still be hard to quantify it.

But consider the following, which is based on what I heard.

In China, either for religious beliefs, or pure lack of compassion, voluntary organ donation is not a common thing.

Then, there is a law or de-facto law that says that if the body of the person executed is not claimed by family, then the organs can be extracted even without the consent of the prisoner.

From this, even though China does not publish execution statistics, we can imagine that a large part of the organs comes from prisoners sentenced to death.
...
Furthermore, FLG prisonners continue to not bow down to the government even in prison, e.g. by doing their <<flg-relition,Falun Gong meditation>>, which makes them clearly identifiable and dangerous to the system.
