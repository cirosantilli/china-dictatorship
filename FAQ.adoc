...
Furthermore, they continue to not bow down to the government even in prison, by doing their <<flg-relition,Falun Gong meditation>>, which makes them clearly identifiable and dangerous to the system.
